...
public class AccountEventHandler {
    ...
    public AccountEventHandler(MongoRepository<Account> mongoRepository) {
        this.mongoRepository = mongoRepository;
        Configurer configurer = DefaultConfigurer.defaultConfiguration()
            .eventProcessing(eventProcessingConfigurer -> eventProcessingConfigurer
                .registerEventHandler(conf -> this));
    }
    ...
    public void on(AccountCreatedEvent event) {
        ...
        mongoRepository.add(new Account(new ObjectId(event.getId()), event.getCustomerId(), event.getBalance()));
    }
    ...
    public void on(AccountDeletedEvent event) {
        ...
        mongoRepository.deleteOne(event.getId());
    }
    ...
    private void updateBalance(String id, double balance) {
        ...
        mongoRepository.replaceOne(account.getHexId(), account);
